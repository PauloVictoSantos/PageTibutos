  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex">
        {/* Lado esquerdo */}
        <div className="w-2/4 bg-[#f3ede6] dark:bg-neutral-900" />

        {/* Lado direito */}
        <div className="w-3/4 bg-linear-to-br from-blue-700 via-blue-600 to-sky-500 dark:from-blue-900 dark:via-blue-800 dark:to-sky-700" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto min-h-screen flex items-center">
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="relative w-24 h-24">
              <Image
                ...
                alt="QR Code"
                fill
                className="object-contain rounded-lg border border-neutral-200 dark:border-neutral-700"
              />
            </div>
        ...
        <motion.div
          ...
          className="ml-auto w-7/12 pl-24"
        >
          <h1 className="text-6xl font-bold text-white dark:text-white leading-tight">
            {employee.name}
          </h1>

          <div className="flex items-center gap-2 mt-2 mb-5 text-white">
            <Landmark className="h-6 w-6 text-sky-200 dark:text-sky-300" />
            <span className="text-2xl font-semibold tracking-wide">
              {employee.department}
            </span>
          </div>

          <div className="flex items-center gap-2 text-blue-100 dark:text-blue-200 mb-4">
            <MapPin className="h-4 w-4 text-sky-200 dark:text-sky-300" />
            <span className="text-sm">{employee.location}</span>
          </div>

          <div className="flex items-center gap-2 text-blue-100 dark:text-blue-200 mb-4">
            <Building2 className="h-4 w-4 text-sky-300 dark:text-sky-400" />
            <span className="text-sm">{employee.secretaria}</span>
          </div>

          {/* BOTÕES */}
          <div className="mt-14 flex gap-4 sm:justify-center md:justify-start">
            {/* WhatsApp */}
            <Tooltip>
