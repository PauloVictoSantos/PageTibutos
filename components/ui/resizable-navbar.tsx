...
<motion.div
  ...
  className={cn(
    "absolute inset-0 hidden flex-1 flex-row items-center justify-center space-x-2 text-sm font-semibold text-neutral-700 dark:text-neutral-200 transition-colors duration-300 lg:flex",
    className,
  )}
>
  {items.map((item, idx) => (
